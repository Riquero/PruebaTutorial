...
public class Alfil extends Pieza {
	...
	public Alfil(final int posicionPieza, final Bando bandoDeLaPieza) {
		super(posicionPieza, bandoDeLaPieza, TipoDePieza.ALFIL);
	}
	...
	@Override
	public Alfil moverPieza(Movimiento movimiento) {
		return new Alfil(movimiento.getCoordenadaDeDestino(), movimiento.getPiezaMovida().getBando());
	}
}
